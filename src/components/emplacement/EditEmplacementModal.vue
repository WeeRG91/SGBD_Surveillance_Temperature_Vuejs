    ...
    <div class="flex min-h-screen items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
        ...
        <h3 class="text-lg font-medium leading-6 text-gray-900">
          Modifier l'emplacement "{{ emplacementName }}"
        </h3>
        ...
        <div class="mt-6 flex justify-end space-x-3">
          ...
          <button
            ...
            @click="submitForm"
            :disabled="!editedEmplacementName"
          >
            Modifier
          </button>
        </div>
...
const editedEmplacementName = ref(props.emplacementName);

const closeModal = () => {
  editedEmplacementName.value = "";
  emit("close");
};

const submitForm = () => {
  if (!editedEmplacementName.value) return;

  emit("submit", editedEmplacementName.value);
